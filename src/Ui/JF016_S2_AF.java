 ...
 * @author LENOVO
 */
public class JF016_S2_AF extends javax.swing.JFrame {

    /**
     * Creates new form JF016_S2_AF
     */
    public JF016_S2_AF() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JF016_S2_AF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JF016_S2_AF().setVisible(true);
            }
        });
    }
