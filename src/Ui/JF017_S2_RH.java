 ...
 * @author LENOVO
 */
public class JF017_S2_RH extends javax.swing.JFrame {

    /**
     * Creates new form JF017_S2_RH
     */
    public JF017_S2_RH() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JF017_S2_RH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JF017_S2_RH().setVisible(true);
            }
        });
    }
