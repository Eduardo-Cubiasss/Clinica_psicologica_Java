...
public class JF_000_S7_GU extends javax.swing.JFrame {
    ...
    public JF_000_S7_GU() {
        ...
        JPContenido.add(panelInicioSesion, "panelInicioSesion");
        ...
        controladorLogin = new Login(modelUsers, panelInicioSesion.getBtn2_JF001_S1_AF(),
                ...
                JPContenido, Procesos, panelInicioSesion.getbtn3_JF001_S1_AF());
        ...
        controladorRegistrar = new RegAdmin_JF002(modelAdmin, modelUsers, modelClinica, panelRegistro, JPContenido, Procesos);

        // Asocia la instancia de JP002_S1_RHP al JPContenido
        JPContenido.add(panelRegistro, "panelRegistro");

        // Establece un color de fondo para el JPContenido
