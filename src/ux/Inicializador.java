...
public class Inicializador {
    ...
    public Inicializador(JF_000_S7_GU vista) {
       ...
       //Estadisticas controladorEstadistica = new Estadisticas();
        ...
        controladorEliminarAnunciosActuales = new EliminarAnunciosActuales(vista.JPContenido, panelEliminarAnunciosActuales, habilitarPaneles);
        ...
        controladorAgregarArticulo = new AgregarArticulo(vista.JPContenido, panelAgregarArticulo, habilitarPaneles);
