...
public class Inicializador {
    ...
    public Inicializador(JF_000_S7_GU vista) {
       ...
       //Estadisticas controladorEstadistica = new Estadisticas();
        ...
        panelesInicializador.setJP035_1_S3_RH(panel35);
        ...
        this.JP035 = panelesInicializador.getJP035_1_S3_RH();
        ...
        controladorvisualizarnotas = new VisualizarNotas(vista.JPContenido, PanelvisualizarNota);
        controladorDocumentosView = new DocumentosDeApoyo(vista.JPContenido, habilitarPaneles, panelDocumentosView);
        controladorCreacionDeAnuncios = new CreacionDeAnuncios(vista.JPContenido, panelCreacionDeAnuncios);
        controladorSeccionDeComentarios = new SeccionDeComentarios(vista.JPContenido, panelSeccionDeComentarios);
        ...
        controladorDetallesDePerfil = new DetallesDePerfil(vista.JPContenido, panelDetallesDePerfil);
        controladorAnunciosActuales = new AnunciosActuales(vista.JPContenido, panelAnunciosActuales);
        ...
        controladorBuscadorEmpleados = new BuscadorEmpleados(vista.JPContenido, panelBuscadorDeEmpleados, modelEmpleado, modelActivity, Procesos);
        controladorSolicitudesDeEmpleados = new SolicitudesDeEmpleados(vista.JPContenido, panelSolicitudesDeEmpleados);
        controladorNuevaSolicitudDeEmpleado = new NuevaSolicitudDeEmpleado(vista.JPContenido, panelNuevaSolicitudDeEmpleado);
        controladorSolicitudesAprobadas = new SolicitudesAprobadas(vista.JPContenido, panelSolicitudAprobada);
        controladorVerSolicitudAprobada = new VerSolicitudAprobada(vista.JPContenido, panelSolicitudAprobadaMensaje);
        controladorSolicitudesAprobadas2 = new SolicitudesAprobadas2(vista.JPContenido, panelSolicitudesAprobadas2);
        controladorVerSolicitudRechazada = new VerSolicitudRechazada(vista.JPContenido, panelSolicitudesRechazadas);
        controladorEliminarAnunciosActuales = new EliminarAnunciosActuales(vista.JPContenido, panelEliminarAnunciosActuales);
        controladorEstadisticas = new Estadisticas(vista.JPContenido, panelEstadisticas);
        ...
        controladorAgregarArticulo = new AgregarArticulo(vista.JPContenido, panelAgregarArticulo);
        controladorMBEliminarArticulo = new MBEliminarArticulo(vista.JPContenido);
        controladorEliminarDocumentosDeApoyo = new EliminarDocumentosDeApoyo(vista.JPContenido, panelEliminarDocumentosDeApoyo);
        ...
        controladorRedactarMensaje = new RedactarMensaje(vista.JPContenido, panelRedactarMensaje);
        controladorCreacionDePruebas = new CreacionDePruebas(vista.JPContenido, panelCreacionDePruebas);
        controladorEscribirEnTuAgendaPersonal = new EscribirEnTuAgendaPersonal(vista.JPContenido, panelEscribirEnTuAgendaPersonal);
        ...
        controladorVerMensajes = new VerMensajes(vista.JPContenido, panelVerMensaje);
        controladorVerMensajeCH = new VerMensajeCH(vista.JPContenido,panelVerMensajeCH);
        controladorMBEliminarCita = new MBEliminarCita(vista.JPContenido);
        controladorCrearCita = new CrearCita(vista.JPContenido, panelCrearCita);
        controladorEstadisticaDeCitas = new EstadisticaDeCitas(vista.JPContenido, panelEstadisticaDeCitas);
        controladorPruebasDF = new PruebasDF(vista.JPContenido, panelPruebasDF);
